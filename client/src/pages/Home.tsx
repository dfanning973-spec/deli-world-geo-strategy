...
const quotePlans = [
  {
    ...
    modules: [
      ...
      },
      {
        title: "信任引擎",
        items: [
          "渠道覆盖：50+导航站收录，多渠道信任背书增强，解决“AI信任来源”问题",
          "品牌曝光提升：3–5倍",
        ],
      },
      {
        ...
        items: [
          "PR稿：300–600篇，深度内容定制",
          "权威媒体 + 行业媒体组合分发：品牌声量全网提升",
          "AI平台市场分析调研报告：30个Topic词+3家竞品表现分析+蓝海机会洞察",
        ],
      },
      {
        title: "深度分析报告",
        items: [
          "周报：多维度详细周报",
          "SEO分析报告：站点结构诊断+核心关键词布局+优化行动清单",
          "GEO索引分析：目标关键词覆盖+本地竞争格局解析+区域流量获取",
          "关键词表现追踪：核心关键词排名追踪+流量与点击率分析+效果可视化",
          "网站流量洞察：流量来源拆解+用户行为分析+高价值入口",
        ],
      },
      {
        title: "效果说明",
        items: [
          "seo优化：60%–80%页面被google收录（162–216个）",
          "AI优化：30–60%落地页/核心关键词被AI收录（81–162个），被收录代表在各大AI平台上有排名，前五、前三、甚至第一",
        ],
      },
    ],
    comparison: {
      ...
      trust: "50+ 导航站收录",
      pr: "300–600 篇 PR稿",
      report: "30 Topic + 3 家竞品",
      effect: "Google 收录 162–216 个；AI 收录 81–162 个",
    },
  },
  {
    id: "plus",
    ...
    modules: [
      {
        title: "AI落地页体系建设",
        items: [
          "核心关键词：180个，阶梯式权重分配+跨区域GEO定向+动态优化机制",
          "多语言：3种",
          "多语言本地化落地页：540个",
          "核心关键词语义+深度内容表达",
          "围绕用户真实搜索意图",
      ...
      },
      {
        title: "信任引擎",
        items: [
          "渠道覆盖：50+导航站收录×2，多渠道信任背书增强，解决“AI信任来源”问题",
          "品牌曝光提升：5–8倍",
        ],
      },
      {
        title: "内容资产分发",
        items: [
          "PR稿：300–600篇，深度内容定制×2",
          "权威媒体 + 行业媒体组合分发：行业影响力霸屏级提升；行业话语构建+百万级媒体曝光",
          "AI平台市场分析调研报告：50个Topic词+5家竞品深度分析+战略级建议",
        ],
      },
      {
        title: "深度分析报告",
        items: [
          "周报：多维度详细周报",
          "SEO分析报告：爬取与索引检测+数据与移动端校验+问题修复方案",
          "GEO索引分析：用户意图拆解+竞争壁垒解析+内容与排名提升",
          "关键词表现追踪：排名与流量复盘+算法与竞争研判+排名波动预测",
          "网站流量洞察：来源与用户分析+转化与价值拆解+渠道贡献拆解",
          "高潜关键词机会挖掘：搜索引擎规则解析+优先收录因子分析+提升曝光策略",
          "行业趋势分析报告：竞品关键词追踪+外链策略监控+差异化竞争输出",
          "阶段策略复盘与优化建议：数据表现与算法复盘+内容矩阵动态调整+下一阶段规划",
        ],
      },
      {
        title: "效果说明",
        items: [
          "seo优化：60%–80%页面被google收录（324–432个）",
          "AI优化：40%–70%关键词进Alttop前五甚至前三（216–378个），被收录代表在各大AI平台上有排名，前五、前三、甚至第一",
        ],
      },
    ],
    comparison: {
      ...
      trust: "50+ 导航站收录×2",
      pr: "300–600 篇 PR稿×2",
      report: "50 Topic + 5 家竞品",
      effect: "Google 收录 324–432 个；AI 收录 216–378 个",
    },
  },
];

const quoteComparisonRows = [
  { label: "价格周期", key: "price" },
  { label: "核心关键词", key: "keywords" },
  { label: "多语言落地页", key: "pages" },
  { label: "信任引擎", key: "trust" },
  { label: "PR资产", key: "pr" },
  { label: "调研报告", key: "report" },
  { label: "预期效果", key: "effect" },
] as const;
        ...
        >
          ...
          {isOpen && (
            <CardContent className="pt-0 space-y-3 sm:space-y-4 border-t">
              <div>
                <p className="font-semibold text-xs sm:text-sm mb-2 text-primary">
                  主要工作
                </p>
...
export default function Home() {
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative min-h-screen sm:min-h-[70vh] flex items-center justify-center text-center px-4 sm:px-6 py-12 sm:py-16 overflow-hidden">
        <img
          src={heroBg}
          alt=""
          aria-hidden="true"
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            <div className="bg-white/10 backdrop-blur-md px-6 py-3 rounded-lg border border-white/20">
              <p className="text-sm text-white/70">
                得力集团：全球领先的智慧打印设备与工业工具（ToB）解决方案商
              </p>
            </div>
          </div>
        </div>
          ...
          <Card className="border-0 shadow-lg">
            <CardContent className="pt-8 space-y-6">
              <p className="text-base sm:text-lg leading-relaxed text-foreground/90">
                在智能办公与工业数字化转型时代（Smart Office / Enterprise
                Sourcing / Digital
                Manufacturing），全球企业对于一站式大办公物资与专业工器具的需求已经从传统的碎片化分散采购，转变为多元化、平台级、一站式的降本增效采购需求。
              </p>
              <div className="bg-blue-50 p-4 rounded-lg border-l-4 border-primary">
                ...
                <ul className="space-y-2 text-sm text-foreground">
                  ...
                  <li>
                    • "One-stop office equipment supplying for enterprise"
                  </li>
              ...
              <p className="text-base sm:text-lg leading-relaxed text-foreground/90">
                因此，得力集团的全球增长策略重点围绕：
                <strong>
                  智慧办公打印 + 数字化工器具 + B2B一站式供应链技术
                </strong>
                。我们通过获得全球主流行业认证（如能源效率、安全合规、环保认证等）的产品，系统化覆盖全球政企采购、商业办公、工业制造及智能工厂需求，助力企业构建高效、集约的数字化采购与大办公基座。
              </p>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="max-w-6xl mx-auto">
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-sm leading-relaxed">
                    得力集团（DELI
                    WORLD）是全球领先的智慧办公与一站式整体解决方案商，提供包括企业级智慧打印机、数码复合机、智能会议终端，以及得力工具（Deli
                    Tools）旗下的专业级手工具、电动工具和工业五金等全栈产品。公司产品服务全球
                    100+
                    国家和地区，广泛应用于商业企业、政府机构、跨国集团及大型制造工厂。
                  </p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground font-semibold mb-2">
                  ...
                  <p className="text-sm">
                    商业批量办公、企业智能打印中心、数字化仓储集采、工厂维保（MRO）工器具配套、全球跨境电商
                    B2B 采购网。
                  </p>
                </div>
              </CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <p className="text-xs sm:text-sm">
                    客户目前在全球 AI 搜索引擎（如 Perplexity, ChatGPT Search,
                    Gemini）中尚未建立起针对
                    ToB（企业级）核心意图词的高权重、权威性引用源，部分核心办公设备及工具类产品的搜索可见度仍有较大提升空间。前期的核心目标是建立智慧打印（Printer）与专业工具（Tools）相关高商业意向词的索引与内容深度覆盖。
                  </p>
                </div>
                <div>
                  <p className="text-sm text-muted-foreground font-semibold mb-2">
                  ...
                  <p className="text-xs sm:text-sm">
                    智慧大办公与工业装备整体解决方案供应商。主要客户为跨国企业、政府机构、集采平台、科技巨头、以及全球网络渠道集成商。盈利模式包括
                    ToB
                    智能硬件设备销售、大客户集采长期服务协议、供应链整体采购及系统授权。客单价高，决策周期较长（B2B
                    模式）。
                  </p>
                </div>
              </CardContent>
          ...
          <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
            ...
            <p className="text-sm text-foreground mb-4">
              <strong>
                核心语种：多语种覆盖（英语 / 越南语 / 俄语 / 韩语 ）
              </strong>
            </p>
            <ul className="space-y-3 text-sm text-foreground">
              <li>
                <strong>英语（全球核心）</strong> - 覆盖北美及欧洲高客单价 B2B
                市场，抢占智能打印（Printer）企业级采购决策。
              </li>
              <li>
                <strong>越南语（东盟制造）</strong> -
                辐射东南亚新兴工业区，聚焦智能工厂及车间维保所需的工业级工具（Tools）集采。
              </li>
              <li>
                <strong>俄语（独联体贸易）</strong> -
                覆盖欧亚及独联体重点市场，建立得力五金工具与大办公设备的 B2B
                渠道代理索引。
              </li>
              <li>
                <strong>韩语（亚太商务）</strong> -
                针对日韩高端跨国企业集采，提升智慧打印终端与数字化会议设备在亚太
                AI 搜索中的可见度。
              </li>
              <li>
                <strong>AI 引擎优先</strong> - 5 种语种深度对标 AI
                大模型（GPT/Claude/Gemini）语料，大办公与专业工器具的 GEO
                效果最显著。
              </li>
            </ul>
            <p className="text-xs text-muted-foreground mt-4">
              多语种矩阵（结合海外分支本地化）是得力集团建立全球智慧办公设备与专业工具技术权威、抢占国际
              B2B 采购流量最高效的路径。
            </p>
          </div>
        </div>
          ...
          <div className="mb-8">
            <Card className="shadow-lg">
              <CardContent className="pt-6">
                ...
                <p className="text-sm text-foreground mb-4">
                  通过 Programmatic SEO + GEO（AI
                  搜索优化）覆盖海外智慧大办公物资、智能打印设备及工业级工器具的采购搜索场景。
                </p>
                <p className="text-sm text-foreground mb-4">
                  <strong>核心逻辑：</strong>
                  模拟海外行政主管、采购经理、供应链决策者（Sourcing Manager）及
                  IT 部门主管在 Google / ChatGPT / AI 搜索中的真实问题。
                </p>
                <p className="text-sm text-foreground">
                  通过系统化页面覆盖：企业级智能打印机/复印机产品搜索、数字化一站式办公集采方案、全球
                  MRO
                  工业级五金工具标准（如能效/安全/材质认证）、全球绿色办公合规认证要求以及行业大客户供应链集采指南。
                </p>
              </CardContent>
            </Card>
          </div>
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-2">
                      {[
                        ...
                        <div
                          key={i}
                          className="bg-blue-50 p-2 rounded text-xs text-foreground"
                        >
                          • {kw}
                        </div>
                      ))}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <Card className="shadow-lg mb-8">
            <CardContent className="pt-8">
              ...
              >
                谷歌收录率：
                <span className="text-3xl sm:text-4xl text-primary ml-1">
                  60% ~ 80%
                </span>
              </h3>
              <p className="text-base text-foreground mb-6 leading-relaxed">
                这意味着我们做的 <strong className="font-semibold">1500</strong>{" "}
                个页面里，有 <strong className="font-semibold">900~1200</strong>{" "}
                个页面会被谷歌收录并展示靠前。
              </p>
              ...
              <p className="text-base text-foreground mb-4 leading-relaxed">
                在与智慧大办公集采 / B2B 工业工具相关的 AI 搜索 / AI
                推荐结果中，意味着{" "}
                <strong className="font-semibold">1500</strong> 个关键词里，有{" "}
                <strong className="font-semibold">450~1050</strong>{" "}
                个提示词的相关搜索中会出现{" "}
                <strong className="font-semibold">得力</strong>{" "}
                的品牌，大部分会在{" "}
              ...
              <div className="bg-blue-50 p-4 rounded-lg mb-4">
                <ul className="space-y-2 text-sm text-foreground">
                  <li>
                    • 假设全球企业大办公物资及工器具采购相关搜索行为每月约
                    15,000 ~ 30,000 次
                  </li>
                  <li>
                    • 相关搜索包括：Commercial smart printers、Enterprise laser
                    copiers、Professional hand tools B2B、Industrial power tools
                    catalog
                  </li>
                  <li>
                    • 预计被 AI 提及次数：
                    <strong>3,000 ~ 12,000 次 / 月</strong>
                  </li>
                </ul>
              </div>
              ...
              <p className="text-sm text-foreground mb-4">
                在 AI 搜索结果中：AI
                通常不会直接推荐官网链接。用户看到品牌后常见行为是回到搜索引擎主动搜索客户品牌，以进一步寻找相关产品与解决方案。
              </p>
      ...
      <section className="py-12 sm:py-16 md:py-20 px-4 sm:px-6 bg-gradient-to-b from-purple-50/20 to-background">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid gap-5 md:grid-cols-2">
            {quotePlans.map(plan => (
              <Card
                key={plan.id}
                className={`shadow-lg ${
                  plan.id === "plus" ? "border-primary/40 bg-blue-50/60" : ""
                }`}
              >
                <CardHeader>
                  <div className="flex items-start justify-between gap-3">
                    <div>
                      <div className="mb-3 flex flex-wrap items-center gap-2">
                        ...
                        <Badge
                          variant={plan.id === "plus" ? "default" : "secondary"}
                        >
                          {plan.tag}
                        </Badge>
                      </div>
                ...
                <CardContent className="space-y-6">
                  <div className="rounded-xl border border-primary/20 bg-blue-50/80 px-5 py-5">
                    <p className="text-sm font-semibold text-primary">
                      GEO+AI 全域推广服务报价
                    </p>
                    <p className="mt-3 text-5xl font-bold leading-none text-primary">
                      {plan.price}
                    </p>
          ...
          <Card className="mt-6 shadow-md">
            <CardHeader>
              <CardTitle className="text-lg">方案核心差异</CardTitle>
              <CardDescription>
                只保留影响报价决策的关键指标，完整服务明细可在下方展开查看。
              </CardDescription>
            </CardHeader>
            <CardContent>
                ...
                <table className="w-full min-w-[680px] border-collapse text-sm">
                  <thead>
                    <tr className="border-b bg-slate-50/80">
                      <th className="w-32 px-4 py-3 text-left font-semibold text-muted-foreground">
                        对比项
                      </th>
                      {quotePlans.map(plan => (
                        <th
          ...
          <Collapsible className="mt-6">
            <CollapsibleTrigger className="flex w-full items-center justify-center gap-2 rounded-lg border bg-white px-5 py-4 text-sm font-semibold text-primary shadow-sm transition-colors hover:bg-blue-50">
              查看完整服务明细
                ...
                {quotePlans.map(plan => (
                  <div
                    ...
                    className={`rounded-xl border bg-white p-5 shadow-sm ${
                      plan.id === "plus" ? "border-primary/30" : ""
                    }`}
                  >
                    ...
                    <div className="space-y-5">
                      {plan.modules.map(module => (
                        <div key={module.title} className="border-t pt-4">
          ...
          <div className="grid gap-4 sm:p-5 md:p-6">
            {[
              ...
              },
              {
                ...
                target:
                  "15% 关键词进入 Google 首页；2% 关键词进入 AI 搜索结果。",
              },
              {
                month: "第 5 个月",
                ...
                target:
                  "25% 关键词进入 Google 首页；5% 关键词进入 AI 搜索结果。",
              },
              {
                month: "第 6 个月",
                ...
                target:
                  "35% 关键词进入 Google 首页；8% 关键词进入 AI 搜索结果。",
              },
            ].map((item, idx, arr) => (
              <TimelineItem
                key={idx}
